...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
 ...
 while($checkout=mysqli_fetch_array($r,MYSQLI_ASSOC)){
  echo "<tr><td>".hardware($checkout['hardware_id'])."</td><td>".member($checkout['users_id'])."</td><td style='background-color:orange;'>$checkout[date_out]</td><td style='background-color:lightgreen;'>$checkout[date_back]</td></tr>";
 }
 ?>
</table>
